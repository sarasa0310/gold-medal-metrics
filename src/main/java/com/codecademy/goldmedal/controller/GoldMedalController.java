    ...
    private CountryMedalsListResponse getCountryMedalsListResponse(String countryName, String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            case "year":
                ...
                medalsList = goldMedalRepository.findByCountryOrderByYear(countryName);
                break;
            case "season":
                // TODO: list of medals sorted by season in the given order
                medalsList = goldMedalRepository.findByCountryOrderBySeason(countryName);
                break;
            case "city":
                // TODO: list of medals sorted by city in the given order
                medalsList = goldMedalRepository.findByCountryOrderByCity(countryName);
                break;
            case "name":
                // TODO: list of medals sorted by athlete's name in the given order
                medalsList = goldMedalRepository.findByCountryOrderByName(countryName);
                break;
            case "event":
                // TODO: list of medals sorted by event in the given order
                medalsList = goldMedalRepository.findByCountryOrderByEvent(countryName);
                break;
            default:
